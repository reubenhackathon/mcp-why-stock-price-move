...
It does this by:
Fetching real-time financial news (Google News RSS)
Pulling recent stock price data (yfinance)
Structuring both into a reasoning prompt
Sending it to Gemini API
Returning a concise causal explanation
---
